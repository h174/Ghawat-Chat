...
import axios from "axios";
    ...
    const MyCompButton = (params) => {
        const ActionAlumniData = async (data)=>{
                await axios.delete(process.env.SERVER_API+"api/alumni/activity", {data})
                .then((rowData) => {
...
const AlumniActivity = (props) => {
    ...
    const [columnDefs, setColumnDefs] = useState([
        ...
        {headerName:'Guest',field: 'guestName', filter: true},
    ...
    const defaultColDef = useMemo(() => {
       ...
       // Example load data from server
        ...
        useEffect(async () => {
            ...
            await axios.get(`${process.env.SERVER_API}api/alumni/activity`,{
                headers: {
                  'Authorization': token
                },
              })
